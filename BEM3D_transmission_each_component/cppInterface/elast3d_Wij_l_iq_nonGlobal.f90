...
contains
  !------------------------------------------
  !subroutine elast3d_Wij_l_iq_nonGlobal(om,zWij,xco,nx,ely,sing,iq)
...
!    end interface
    ...
    do ngy=1,integ
       ...
       !call elastUij_Sigma_dynamic(xco,yco,elastp%cl,elastp%ct,zs,dUij,dsigma)
...
!             call elastSigma_dynamic(xco,yco,elastp%cl,elastp%ct,zs,dsigma)
!             do i=1,3
!                do j=1,3
!                   do k=1,3
!                      do r=1,3
...
!                do b=1,3
!                   do i=1,3
!                      ccc(r,k,b,i)=ccc(r,k,b,i)+elastp%permut(r,c,k)*bbb(b,i,c)
!                   end do
!                end do
!             end do
!          end do
