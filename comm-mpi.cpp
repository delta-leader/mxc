...
template void ColCommMPI::level_sum(std::complex<double>*, long long) const;
template void ColCommMPI::neighbor_bcast(std::complex<double>*, const long long[]) const;

// complex double
template void ColCommMPI::level_merge(std::complex<float>*, long long) const;
template void ColCommMPI::level_sum(std::complex<float>*, long long) const;
template void ColCommMPI::neighbor_bcast(std::complex<float>*, const long long[]) const;

// double
template void ColCommMPI::level_merge(double*, long long) const;
template void ColCommMPI::level_sum(double*, long long) const;
template void ColCommMPI::neighbor_bcast(double*, const long long[]) const;

// long long
template void ColCommMPI::neighbor_bcast(long long*, const long long[]) const;
